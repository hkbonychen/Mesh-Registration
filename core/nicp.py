...
from core.io import getTriMeshfromPly, ply_from_array
...
def non_rigid_icp_generator(source, target, eps=1e-3,
    ...
    #ply_from_array('aligned_source', 0, source, './output/', True, '__lsfm')
    #ply_from_array('aligned_target', 0, target, './output/', True, '__lsfm')
