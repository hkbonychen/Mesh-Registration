          ...
          ext_modules = [
              Extension("sksparse.cholmod", ["sksparse/cholmod.pyx"],
                        include_dirs=[np.get_include(),
                                      ...
                                      "/home/u/workspace/libs/suitesparse/include"],
                        library_dirs=["/home/u/workspace/libs/suitesparse/lib"],
                        libraries=['cholmod', 'amd', 'btf', 'camd', 'ccolamd', 'colamd',
                                   'cxsparse', 'metis', 'klu', 'suitesparseconfig', 'spqr',
                                   'umfpack'])],
          )
